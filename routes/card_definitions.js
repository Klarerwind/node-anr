var ObjectID = require('mongodb').ObjectID,
  ...
  CardDefinition = require('../models/card_definition').CardDefinition;
...
exports.findById = function (req, res) {
  var id, collection = global.db.collection('card_definitions');
  ...
  collection.findOne({_id: id}, function (err, card) {
    ...
    card.imageUrl = new CardDefinition(card).imageUrl();
    _faction[toCamelCase(card.faction)] = true;
    _type[card.type.toLowerCase()] = true;
    _side[toCamelCase(card.side)] = true;
...
exports.updateCardForm = function (req, res) {
  ...
  collection.findOne({_id: id}, function (err, card) {
    ...
    card.imageUrl = new CardDefinition(card).imageUrl();
    _faction[toCamelCase(card.faction)] = true;
    _type[toCamelCase(card.type)] = true;
    _side[toCamelCase(card.side)] = true;
